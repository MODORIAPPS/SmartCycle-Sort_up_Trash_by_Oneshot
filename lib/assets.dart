...
class ImageAssets {
    ...
    static const String sample_cameraImg = "assets/images/right-hand-1598191_1920.jpg";
...
class TextAssets {
    static const TextStyle mainBold = TextStyle(color: Colors.black,
        fontSize: 22,
        fontWeight: FontWeight.bold,
        fontFamily: "NotoCjkKR");
    static const TextStyle mainRegular = TextStyle(color: Colors.black87,
        fontSize: 18,
        fontWeight: FontWeight.w700,
        fontFamily: "NotoCjkKR",);
    static const TextStyle subBold = TextStyle(color: Colors.black87,
        fontSize: 14,
        fontWeight: FontWeight.w700,
        fontFamily: "NotoCjkKR",);

    static const TextStyle mainBoldW = TextStyle(color: Colors.white,
        fontSize: 22,
        fontWeight: FontWeight.bold,
        fontFamily: "NotoCjkKR");
